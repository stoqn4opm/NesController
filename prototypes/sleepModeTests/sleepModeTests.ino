...
void setup()
{
  ...
  attachInterrupt(0, NULL, LOW); // use interrupt 0 (pin 2) and run function
...
void sleepNow()         // here we put the arduino to sleep
{
    ...
    attachInterrupt(digitalPinToInterrupt(wakePin), NULL, LOW); // use interrupt 0 (pin 2) and run function
                                       // wakeUpNow when pin 2 gets LOW
